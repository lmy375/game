      ...
      _export("GridBoard", GridBoard = class GridBoard {
        ...
        constructor(width, height, tiles) {
          ...
          for (var y = 0; y < height; y++) {
            ...
            for (var x = 0; x < width; x++) row.push("ground");
        ...
        clone() {
          var b = new GridBoard(this.width, this.height);

          for (var y = 0; y < this.height; y++) {
            for (var x = 0; x < this.width; x++) b.grid[y][x] = this.grid[y][x];
          }
