    ...
    execute: function () {
      ...
      _export("UnitSprite", UnitSprite = class UnitSprite {
        constructor(parent, unit, world) {
          ...
          var base = (_unit$faction = (_crd && FACTION === void 0 ? (_reportPossibleCrUseOfFACTION({
            error: Error()
          }), FACTION) : FACTION)[unit.faction]) != null ? _unit$faction : (_crd && FACTION === void 0 ? (_reportPossibleCrUseOfFACTION({
            error: Error()
          }), FACTION) : FACTION).enemy;
          var accent = (_crd && hex === void 0 ? (_reportPossibleCrUseOfhex({
            error: Error()
          ...
          var body = (_crd && meshNode === void 0 ? (_reportPossibleCrUseOfmeshNode({
            error: Error()
          ...
          var head = (_crd && meshNode === void 0 ? (_reportPossibleCrUseOfmeshNode({
            error: Error()
          ...
          var backW = 0.62;
          var hpBack = (_crd && meshNode === void 0 ? (_reportPossibleCrUseOfmeshNode({
            error: Error()
        ...
        setHp(now) {
          ...
          var ratio = this.maxHp > 0 ? Math.max(0, Math.min(1, now / this.maxHp)) : 0;
          var full = 0.58;
        ...
        setFacing(dir) {
          ...
          var [dx, dz] = (_FACE_OFFSET$dir = FACE_OFFSET[dir]) != null ? _FACE_OFFSET$dir : FACE_OFFSET.right;
      ...
      _export("UnitView", UnitView = class UnitView {
        ...
        sync(state) {
          ...
          for (var u of state.units) {
            ...
            var s = this.sprites.get(u.instanceId);
            var world = this.coord.posToWorld(u.pos, 0);
        ...
        project() {
          for (var s of this.sprites.values()) s.node.setPosition(s.world);
        }
        ...
        setSelected(id) {
          for (var [sid, s] of this.sprites) s.setSelected(sid === id);
        }
