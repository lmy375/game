System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function stepMove(state, unit, dir, maxSteps, reason, events) {
    var from = (_crd && clone === void 0 ? (_reportPossibleCrUseOfclone({
      error: Error()
    }), clone) : clone)(unit.pos);
    var vec = (_crd && DIRECTION_VECTOR === void 0 ? (_reportPossibleCrUseOfDIRECTION_VECTOR({
      error: Error()
  ...
  function applyKnockback(state, unit, dir, distance, collisionDamage, events) {
    var res = stepMove(state, unit, dir, distance, "knockback", events);
  ...
  function applySwap(state, a, b, events) {
    var aPos = (_crd && clone === void 0 ? (_reportPossibleCrUseOfclone({
      error: Error()
    }), clone) : clone)(a.pos);
    var bPos = (_crd && clone === void 0 ? (_reportPossibleCrUseOfclone({
      error: Error()
    }), clone) : clone)(b.pos);
  ...
  function applyArrangeLine(state, units, anchor, dir, maxUnits, events) {
    ...
    var sorted = [...units].filter(_crd && isAlive === void 0 ? (_reportPossibleCrUseOfisAlive({
      error: Error()
