    ...
    execute: function () {
      ...
      _export("BattleSimulator", BattleSimulator = class BattleSimulator {
        ...
        simulate(state, action) {
          var next = (_crd && cloneState === void 0 ? (_reportPossibleCrUseOfcloneState({
            error: Error()
        ...
        doMove(state, events, actorId, moveTo) {
          ...
          var reachable = (_crd && computeMoveRange === void 0 ? (_reportPossibleCrUseOfcomputeMoveRange({
            error: Error()
          ...
          var path = (_crd && findPath === void 0 ? (_reportPossibleCrUseOffindPath({
            error: Error()
          ...
          var dead = new Set(state.units.filter(u => u.hp <= 0 && u.instanceId !== actorId).map(u => u.instanceId));
        ...
        doSkill(state, events, actorId, action) {
          ...
          var skill = this.registry.skill(action.skillId);
          var target = {
        ...
        finalize(state, events) {
          var outcome = (_crd && evaluateOutcome === void 0 ? (_reportPossibleCrUseOfevaluateOutcome({
            error: Error()
