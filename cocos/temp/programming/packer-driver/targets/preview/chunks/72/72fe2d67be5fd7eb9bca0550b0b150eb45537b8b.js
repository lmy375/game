  ...
  return {
    ...
    execute: function () {
      ...
      _export("Bootstrap", Bootstrap = (_dec = ccclass("Bootstrap"), _dec(_class = class Bootstrap extends Component {
        ...
        onLoad() {
          var registry = (_crd && createRegistry === void 0 ? (_reportPossibleCrUseOfcreateRegistry({
            error: Error()
          }), createRegistry) : createRegistry)();
          var root = new Node("Game2D5");
          this.node.addChild(root);
          var first = (_crd && levels === void 0 ? (_reportPossibleCrUseOflevels({
            error: Error()
          }), levels) : levels)[0];
          var coord = new (_crd && CoordMap === void 0 ? (_reportPossibleCrUseOfCoordMap({
            error: Error()
          ...
          var board = new (_crd && BoardView === void 0 ? (_reportPossibleCrUseOfBoardView({
            error: Error()
          }), BoardView) : BoardView)();
          ...
          this.units.build();
          var overlay = new (_crd && OverlayView === void 0 ? (_reportPossibleCrUseOfOverlayView({
            error: Error()
          }), OverlayView) : OverlayView)(coord, this.rig);
          overlay.build(this.rig.boardRoot);
          var hud = new (_crd && HudView === void 0 ? (_reportPossibleCrUseOfHudView({
            error: Error()
          }), HudView) : HudView)(this.rig);
          hud.build();
          var fx = new (_crd && SkillEffects === void 0 ? (_reportPossibleCrUseOfSkillEffects({
            error: Error()
          }), SkillEffects) : SkillEffects)(coord, this.rig);
          fx.build();
          var animator = new (_crd && EventAnimator === void 0 ? (_reportPossibleCrUseOfEventAnimator({
            error: Error()
          ...
          input.on(Input.EventType.KEY_DOWN, e => {
            ...
            var idx = ((_e$keyCode = e.keyCode) != null ? _e$keyCode : 0) - 49; // 数字键 1 → keyCode 49
