System.register(["cc"], function (_export, _context) {
  ...
  function unlitMat(color, transparent = false) {
    const m = new Material();
  ...
  function meshNode(name, parent, mesh, mat, shadow = true) {
  ...
  function uiNode(name, parent, w = 0, h = 0) {
    const n = new Node(name);
  ...
  function uiGraphics(parent, w = 0, h = 0) {
