    ...
    execute: function () {
      ...
      _export("HudView", HudView = class HudView {
        ...
        build() {
          ...
          const orderPanel = (_crd && uiSolid === void 0 ? (_reportPossibleCrUseOfuiSolid({
            error: Error()
          ...
          const rosterPanel = (_crd && uiSolid === void 0 ? (_reportPossibleCrUseOfuiSolid({
            error: Error()
          ...
          const logPanel = (_crd && uiSolid === void 0 ? (_reportPossibleCrUseOfuiSolid({
            error: Error()
        ...
        renderRoster(rows) {
          const fmt = r => `${r.sel ? "▶ " : "  "}${r.dead ? "☠ " : ""}${r.name}  速${r.speed}  ${Math.max(0, r.hp)}/${r.maxHp}`;
        ...
        showMenu(title, items, showUndo, uiPos, cbs) {
          ...
          const panelW = 168;
          const bg = (_crd && uiSolid === void 0 ? (_reportPossibleCrUseOfuiSolid({
            error: Error()
          }), uiSolid) : uiSolid)(this.menu, panelW, panelH, (_crd && UI === void 0 ? (_reportPossibleCrUseOfUI({
            error: Error()
          }), UI) : UI).panel).node;
          const titleLab = (_crd && uiLabel === void 0 ? (_reportPossibleCrUseOfuiLabel({
            error: Error()
          ...
          for (const it of items) {
            this.button(bg, `${it.name}`, panelW - 20, btnH, new Vec3(0, y, 0), it.disabled, (_crd && UI === void 0 ? (_reportPossibleCrUseOfUI({
              error: Error()
        ...
        showConfirm(skillName, desc, canFire, cbs) {
          ...
          const text = (_crd && uiLabel === void 0 ? (_reportPossibleCrUseOfuiLabel({
            error: Error()
        ...
        showBanner(win, onNext) {
          ...
          const lab = (_crd && uiLabel === void 0 ? (_reportPossibleCrUseOfuiLabel({
            error: Error()
