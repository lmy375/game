    ...
    execute: function () {
      ...
      _export("OverlayView", OverlayView = class OverlayView {
        ...
        show(o) {
          ...
          for (const a of (_o$arrows = o.arrows) != null ? _o$arrows : []) {
            var _o$arrows;

            this.arrow(a.from, a.to);
          }

          for (const d of (_o$damage = o.damage) != null ? _o$damage : []) {
            var _o$damage;
        ...
        arrow(from, to) {
          ...
          if (len < 1e-3) return;
          const shaft = (_crd && meshNode === void 0 ? (_reportPossibleCrUseOfmeshNode({
            error: Error()
        ...
        previewLabel(p, amount, kind, lethal) {
          const color = kind === "heal" ? (_crd && UI === void 0 ? (_reportPossibleCrUseOfUI({
            error: Error()
